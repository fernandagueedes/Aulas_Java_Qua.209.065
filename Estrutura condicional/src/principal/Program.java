...
public class Program {
	...
	public static void main(String[] args) {
		 ...
		 * comando if terminou. o else significa "se não" o boolean retorna "verdadeiro"
		 * ou "falso" quando eu nego a minha variável ela muda o valor (como na tabela
		...
		// Exemplo usando resto da divisão para saber se é impar ou par
